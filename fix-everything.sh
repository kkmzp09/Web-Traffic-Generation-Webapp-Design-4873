...
echo "Step 1: Removing free-scan-api import from server.js..."
sed -i '/free-scan-api/d' server.js

echo "Step 2: Adding email endpoint to seo-automation-api.js..."
cp seo-automation-api.js seo-automation-api.js.backup-final
